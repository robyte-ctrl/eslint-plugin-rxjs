...
exports.rule = (0, utils_1.ruleCreator)({
    ...
    create: (context) => {
        ...
        function shouldDisallow(args) {
            const names = args
                .map((arg) => {
                if ((0, etc_1.isLiteral)(arg) && typeof arg.value === "string") {
                    return arg.value;
                }
                if ((0, etc_1.isIdentifier)(arg)) {
                    return arg.name;
                }
                if ((0, etc_1.isMemberExpression)(arg) && (0, etc_1.isIdentifier)(arg.property)) {
        ...
        function checkNode(node) {
            ...
            const hasUnsafeOfType = node.arguments.some((arg) => {
                if ((0, etc_1.isCallExpression)(arg) &&
                    (0, etc_1.isIdentifier)(arg.callee) &&
