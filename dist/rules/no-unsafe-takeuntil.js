...
const rule = (0, utils_1.ruleCreator)({
    ...
    create: (context) => {
        ...
        function checkNode(node) {
            const pipeCallExpression = (0, etc_1.getParent)(node);
            ...
            pipeCallExpression.arguments.reduceRight((state, arg) => {
                ...
                let operatorName;
                if ((0, etc_1.isIdentifier)(arg.callee)) {
                    operatorName = arg.callee.name;
                }
                else if ((0, etc_1.isMemberExpression)(arg.callee) &&
                    (0, etc_1.isIdentifier)(arg.callee.property)) {
