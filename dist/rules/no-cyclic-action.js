...
const rule = (0, utils_1.ruleCreator)({
    ...
    create: (context) => {
        ...
        const { getType, typeChecker } = (0, etc_1.getTypeServices)(context);
        function checkNode(pipeCallExpression) {
            const operatorCallExpression = pipeCallExpression.arguments.find((arg) => (0, etc_1.isCallExpression)(arg) &&
